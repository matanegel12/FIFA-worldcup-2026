...
class MainBottomNav extends StatelessWidget {
  final VoidCallback onUpcomingTapped;
  final VoidCallback onResultsTapped;
  final VoidCallback onLeaderboardTapped;
  final VoidCallback onPredictionsTapped;
  final int currentIndex; // 0=upcoming, 1=results, 2=leaderboard, 3=predictions

  const MainBottomNav({
    required this.onUpcomingTapped,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _NavButton(
              icon: Icons.home,
              tooltip: 'Upcoming Games',
              isActive: currentIndex == 0,
              onTap: onUpcomingTapped,
            ),
            _NavButton(
      ...
      child: MouseRegion(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            height: 44,
            decoration: BoxDecoration(
              color: _isHovered ? AppTheme.surface : AppTheme.navBarBackground,
              borderRadius: borderRadius,
            ),
            child: Icon(
              widget.icon,
              size: 24,
              color: widget.isActive ? AppTheme.secondary : AppTheme.navInactive,
            ),
          ),
        ),
      ),
